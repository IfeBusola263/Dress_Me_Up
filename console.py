...
class HBNBCommand(cmd.Cmd):
    ...
    prompt = '(dress) ' if sys.__stdin__.isatty() else ''

    classes = {
               'ParentModel': ParentModel, 'User': User, 'Event': Event,
               'MakeupStyle': MakeupStyle, 'Dress': Dress, 'HairStyle': HairStyle,
              }

    dot_cmds = ['all', 'count', 'show', 'destroy', 'update']
    class_keys = {
        "ParentModel": ["id", "created_at", "updated_at"],
        "User": [
            "id",
            "created_at",
            "updated_at",
        ...
        "Event": ["id", "created_at", "updated_at", "event_id", "name"],
        "Dress": [
            "id",
            "created_at",
            "updated_at",
